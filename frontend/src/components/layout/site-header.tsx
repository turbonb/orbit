...
export function SiteHeader() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-30 bg-[linear-gradient(120deg,rgba(60,9,108,0.65),rgba(90,24,154,0.55),rgba(255,145,0,0.28))] backdrop-blur-lg">
      <div className="flex h-20 w-full items-center gap-4 px-2 sm:px-4 lg:px-6">
        ...
        <nav className="hidden flex-[2] items-center justify-center gap-8 pr-2 uppercase tracking-[0.4em] text-xs text-white/65 xl:flex">
