  ...
  return (
    <section id="about" className="section-shell relative py-24">
      <div className="container relative grid gap-10 lg:grid-cols-[1.2fr_1fr] lg:items-center">
        ...
        <Card className="border border-primary/25 bg-card/85 shadow-[0_20px_60px_hsl(var(--brand-void)_/_0.4)]">
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            {signals.map(({ label, value }) => (
              <div
                key={label}
                className="space-y-1 rounded-xl border border-primary/30 bg-secondary/60 p-4 shadow-inner shadow-primary/30"
              >
